...
ADCSetup.obj: ../ADCSetup.c $(GEN_OPTS) $(GEN_SRCS)
	...
	"C:/ti/ccsv5/tools/compiler/arm_4.9.7/bin/cl470" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me -g --include_path="C:/ti/ccsv5/tools/compiler/arm_4.9.7/include" --include_path="C:/StellarisWare/inc" --include_path="C:/StellarisWare/driverlib" --include_path="C:/StellarisWare/utils" --include_path="C:/StellarisWare" --define=css="ccs" --define=PART_LM4F120H5QR --define=TARGET_IS_BLIZZARD_RA2 --define=UART_BUFFERED --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="ADCSetup.pp" $(GEN_OPTS__FLAG) "$<"
